...
public class NotEnoughKeysResourcePack implements IResourcePack {

    protected ModContainer ownerContainer;

    public NotEnoughKeysResourcePack(ModContainer container) {
    ...
    private String getResourcePath(ResourceLocation location) {
        return "/assets/notenoughkeys/" + location.getResourcePath();
    }

    private InputStream getResourceStream(ResourceLocation resourceLocation) {
        InputStream lis = NotEnoughKeysResourcePack.class.getResourceAsStream(getResourcePath(resourceLocation));
        return lis;
    }
    ...
    public Set getResourceDomains() {
        return ImmutableSet.of("notenoughkeys");
    }
